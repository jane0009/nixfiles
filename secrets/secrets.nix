let
  pubkeys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEP3lZBtAcrvQy7OVyGqVdCG7qn0vsgrjdAlnY8z9LMM" # this is LITERALLY my key for this system but it doesnt work im so pissed rn
